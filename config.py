...
CREATORS_API_TPD_LIMIT = int(
    os.getenv("CREATORS_API_TPD_LIMIT", str(CREATORS_API_TPD))
)
CREATORS_API_TPD_RESERVE = float(os.getenv("CREATORS_API_TPD_RESERVE", "0.10"))
CREATORS_API_TPS_LIMIT = float(
    os.getenv("CREATORS_API_TPS_LIMIT", str(CREATORS_API_TPS))
)
